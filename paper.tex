...
The availability of feature-rich and robust cheminformatics toolkits has started to bear fruit in the development of higher-level tools and applications that are built using these toolkits. 
