...
an award-winning `molecular workbench' for life sciences with a dynamic plugin architectur, and which wraps cheminformatics functionality behind user-friendly interfaces and graphical editors. All functionality in Bioclipse is completely scriptable using an integrated high-level language called Bioclipse Scripting Language (BSL), which can be used for invoking functionality or to automate complex tasks~\cite{Bioclipse2}.
