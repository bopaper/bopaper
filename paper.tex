...
Open workflow systems such as Taverna \cite{Hull:2006p60} have opened the door for 
an easy and seamless integration of free and open software (FOS) components into executable workflows 
...
code donated by Novartis. More recently, GGA Software Services (a
contract programming company) released the Indigo toolkit
\cite{WebIndigo} and associated software in 2009 under the GPL. [More
text on Indigo here]
