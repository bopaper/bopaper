...
\address{%
    ...
    \iid(6)NIH Center for Translational Therapeutics, 9800 Medical Center Drive, Rockville, MD 20878, USA \\
    \iid(7)St. Olaf College, 1520 St. Olaf Ave., Northfield, MN 55057, USA \\
    \iid(8)Kitware, Inc., 28 Corporate Drive, Clifton Park, NY 12065, USA \\
    \iid(9)Department of Chemistry, University of Pittsburgh, 219 Parkman Avenue, Pittsburgh, PA 15260, USA \\
    \iid(10)Department of Engineering, Computer Science, Physics, and Mathematics, Oral Roberts University, 7777 S. Lewis Ave. Tulsa, OK 74171, USA \\
    \iid(11)Leiden Institute of Chemistry, Universiteit Leiden, Einsteinweg 55, 2333 CC Leiden, The Netherlands \\
    \iid(12)GGA Software Services LLC, 41 Nab. Chernoi rechki 194342, Saint Petersburg, Russia \\
    \iid(13)Cheminformatics and Metabolism Team, European Bioinformatics Institute (EBI), Wellcome Trust Genome Campus, Hinxton, Cambridge, UK \\
    \iid(14)Department of Chemistry, University of Washington, Seattle, WA 98195, USA \\
    \iid(15)iChemLabs, 200 Centennial Ave., Suite 200, Piscataway, NJ 08854, USA \\
    \iid(16)Division of Molecular Toxicology, Institute of Environmental Medicine, %
...
Silicos has released several Open Source utilities based on
...
the laboratory notebook page.  Since the database reflects all data
from the notebooks, many experiments will be short of completely
optimized and includes experiments in progress, ambiguous results and
failed runs.  Unlike most reaction databases that only identify
experiments successfully reported in the literature, Reaction Attempts
is meant to be used to easily discover what researchers are trying to
accomplish thus potentially forging collaborations more quickly~\cite{UsefulChemSocialNetworks}
or providing useful knowledge about what doesn't work.

The database can be accessed using
a web-based Reaction Attempts Explorer
\cite{ReactionAttemptsExplorer}.
The explorer allows you to find reaction attempts either by reactant
or product name, via a series of dynamic dropdowns, or by performing a
substructure search. Found reactions are shown graphically as schemes
with accompanying structure images and text with links to the lab
notebook pages, the ChemSpider pages for each compound, and a separate
web service, The Optimal Solvent Selector
[http://usefulchem.blogspot.com/2010/08/reaction-attempts-solvent-selector.html,
that predicts the solubility of the reactants and product in 72
solvents and sorts by theoretical maximum yield.  The Reaction
Attempts Explorer allows researchers to easily find patterns in
reactions that have already been performed and since the data are open
...
easily found \cite{ekins_collaboration_2011}.
    ...
    \mbox{
     \begin{tabular}{|c|c|c|}
       \hline \textbf{Name} & \textbf{Website}  \\ \hline
        ...
        \textbf{Chemistry Development Kit (CDK)} \cite{Steinbeck2003, Steinbeck2006} & http://cdk.sf.net \\ \hline
        ...
        \textbf{CDK-Taverna} \cite{Kuhn:2010p4001} & http://cdktaverna.wordpress.com \\ \hline
        ...
        \textbf{OrChem} \cite{RijnbeekS10} & http://orchem.sf.net \\ \hline
