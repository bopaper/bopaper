...
30 different calculated attributes. A related BO project,
GaussSum~\cite{WebGaussSum},
is a GUI that builds on top of cclib to allow predicted properties to
be compared to experimental properties (for example, the calculated
vibrational frequencies and the IR spectrum).
