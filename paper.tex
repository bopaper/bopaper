...
\author{
  ...
  \and
  Craig A James$^{11}$%
  \email{Craig A James - cjames@emolecules.com}
  \and
  Nina Jeliazkova$^{12}$%
  \email{Nina Jeliazkova - jeliazkova.nina@gmail.com}
  \and
  Andrew SID Lang$^{13}$%
  ...
  \and
  David C Lonie$^{15}$%
  \email{David C Lonie - loniedavid@gmail.com}
  \and
  Daniel M Lowe$^4$%
  \email{Daniel Lowe - dl387@cam.ac.uk}
  \and
  J\'{e}r\^{o}me Pansanel$^{16}$%
  \email{J\'{e}r\^{o}me Pansanel - j.pansanel@pansanel.net}
  \and
  Dmitry Pavlov$^{17}$%
...
\address{%
    ...
    \iid(2)NIH Center for Translational Therapeutics, 9800 Medical Center Drive, Rockville, MD 20878, USA \\
    \iid(3)Division of Molecular Toxicology, Institute of Environmental Medicine, %
        Nobels v\"ag 13, Karolinska Institutet, 171 77 Stockholm, Sweden \\
    \iid(4)Unilever Centre for Molecular Sciences Informatics, Department of Chemistry, University of Cambridge, Lensfield Road, CB2 1EW, UK \\
    \iid(5)Department of Pharmaceutical Biosciences, Uppsala University, Box 591, 751 24 Uppsala, Sweden \\
    \iid(6)Department of Chemistry, Drexel University, 32nd and Chestnut streets, Philadelphia, PA 19104, USA \\
    \iid(7)Chemical Biology Laboratory, Basic Research Program, SAIC-Frederick,
Inc., NCI-Frederick, Frederick, MD 21702, USA \\
    ...
    \iid(11)eMolecules Inc., 380 Stevens Ave., Solana Beach, California 92075, USA \\
    \iid(12)Ideaconsult Ltd., 4.A.Kanchev str., Sofia 1000, Bulgaria \\
    \iid(13)Department of Engineering, Computer Science, Physics, and Mathematics, Oral Roberts University, 7777 S. Lewis Ave. Tulsa, OK 74171, USA \\
    \iid(14)Leiden Institute of Chemistry, Leiden University, Einsteinweg 55, 2333 CC Leiden, The Netherlands \\
    \iid(15)Department of Chemistry, State University of New York at Buffalo, Buffalo, NY 14260-3000, USA \\
    \iid(16)Universit\'{e} de Strasbourg, IPHC, CNRS, UMR7178, 23 rue du Loess 67037, Strasbourg, France \\
    \iid(17)GGA Software Services LLC, 41 Nab. Chernoi rechki 194342, Saint Petersburg, Russia \\
    \iid(18)Cheminformatics and Metabolism Team, European Bioinformatics Institute (EBI), Wellcome Trust Genome Campus, Hinxton, Cambridge, UK \\
    \iid(19)Department of Chemistry, University of Washington, Seattle, WA 98195, USA \\
    \iid(20)iChemLabs, 200 Centennial Ave., Suite 200, Piscataway, NJ 08854, USA 
}%
...
Open Standards.
		...
		contribution looks back on the work carried out by the
Blue Obelisk in the past 5 years and surveys progress and
...
This contribution looks back on the work carried out by the Blue
Obelisk over the past 5 years in the areas of Open Data, Open
...
practice. Several groups~\cite{willighagen_resource_2011,chen_chem2bio2rdf_2010} are experimenting with 
...
Despite this positive news, little chemical data compatible
with these principles has become
available from the traditional chemistry fields of organic,
inorganic, and solid state chemistry. Table~2 lists a few notable
exceptions, some of which are discussed further below.
There is also data available using licenses
not compatible with the Panton Principles, but where the user
is allowed to modify and redistribute the data. A new data
set in this category is the data from the ChEMBL database~\cite{Overington2009},
which is available under the Creative Commons Share-Alike
Attribution license. The RSC ChemSpider database~\cite{chemspider}, although
...
Structure Repository~\cite{BODR}. It aims to provide 3D coordinates, InChIs and several
...
Please include your completing interests statement here.
...
\begin{tabular}{|l|c|p{9cm}|}
  ...
  \textbf{Chempedia}~\cite{Chempedia} & CC0 & Crowd-sourced chemical
names (project discontinued but data still available) \\ \hline
...
\\
\bigskip Overview of major open chemical data available under a license or waiver compatible with the Panton Principles.
