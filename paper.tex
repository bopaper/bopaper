...
on which tools and applications can be built. Now that these toolkits
have reached an acceptable level of stability and functionality, an
increasing amount of software is being developed using these
toolkits. A number of Open Source applications including Bioclipse,
XXX have been developed.

More interestingly, commercial groups have released Open Source tools
based on these toolkits. An recent example of such an interaction 
is Silicos (a Belgian company that provides services
in the area of cheminformatics XXXX rephrase), has released several
command line applications based on Open Babel. For example, the Pharao
...
fitering by molecular property and XXX. Another example of Open Source
