...
\usepackage{lscape} % Landscape orientation for tables
    ...
    \mbox{
     \begin{tabular}{|c|c|c|}
       \hline \textbf{Name} & \textbf{Website}  \\ \hline
        ...
        \multicolumn{2}{|c|}{\textbf{Second Generation}} \\ \hline
       ...
       \multicolumn{2}{|c|}{\textbf{Integration}} \\ \hline
        ...
        \textbf{Bingo}  & http://XXX.XXX.XXX \\ \hline
        \textbf{MyChem}  & http://XXX.sf.net \\ \hline
        \textbf{OrChem} \cite{RijnbeekS10} & http://orchem.sf.net \\ \hline
        \textbf{PGChem}  & http://XXX.sf.net \\ \hline
       ...
       \multicolumn{2}{|c|}{\textbf{Other}} \\ \hline
        \textbf{cclib}  & http://cclib.sf.net \\
        \hline
%% GaussSum, QMForge
       \end{tabular}
      }
